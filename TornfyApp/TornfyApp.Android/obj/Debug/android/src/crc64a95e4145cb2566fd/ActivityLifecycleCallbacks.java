...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Acr.UserDialogs.Extended.Platforms.Android.Infrastructure.ActivityLifecycleCallbacks, Acr.UserDialogs.Extended", ActivityLifecycleCallbacks.class, __md_methods);
	}
	...
	public ActivityLifecycleCallbacks ()
	{
		...
		if (getClass () == ActivityLifecycleCallbacks.class) {
			mono.android.TypeManager.Activate ("Acr.UserDialogs.Extended.Platforms.Android.Infrastructure.ActivityLifecycleCallbacks, Acr.UserDialogs.Extended", "", this, new java.lang.Object[] {  });
		}
	}
