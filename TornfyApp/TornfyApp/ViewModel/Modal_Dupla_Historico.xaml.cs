...
{
    public partial class Modal_Dupla_Historico : PopupPage
    {
        public Modal_Dupla_Historico(Chaves jogador)
        {
            InitializeComponent();
            ...
            else
            {
                ...
                {
                    path_1 = jogador.img_path3,
                    nome_j1 = jogador.nome_j3,
                    id_j1 = jogador.id_j3,
                };
                ...
                {
                    path_1 = jogador.img_path4,
                    nome_j1 = jogador.nome_j4,
                    id_j1 = jogador.id_j4,
                };
