...
{
    public partial class Meu_Historico_Duplas : ContentPage
    {
        ...
        public Meu_Historico_Duplas(Config_Home config, int Id_jogador)
        {
        ...
        {
            int qtd = 0;
            Lista_jogos_recentes = await API_Service.ObterHistorico_Jogos_Novo(qtd, id_jogador, ano, false);
